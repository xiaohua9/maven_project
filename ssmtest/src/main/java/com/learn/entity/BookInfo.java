...
public class BookInfo {
    ...
    public BookInfo(String book_code, String book_name, BookType book_type, String book_author, String publish_press, String publish_date, String is_borrow) {
    ...
    public BookInfo(int book_id, String book_code, String book_name, BookType book_type, String book_author, String publish_press, String publish_date, String is_borrow) {
        this.book_id = book_id;
        this.book_code = book_code;
        this.book_name = book_name;
        this.book_type = book_type;
